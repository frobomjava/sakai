...
// for group-owned student pages, put it in the worksite of the current user
	...
	public MultipartFile ocApiConvert()throws ApiException,IOException {
		...
		String destinationPath = "E:/test/temp.swf";
		String filepath = "E:/test/source.pptx";
		...
		try{
			...
			if (file != null) {
				...
				if (i > 0) {
					...
					System.out.println("outside>>"+extension);
					//EDITED CODE
					if (extension.equalsIgnoreCase("pptx") || extension.equalsIgnoreCase("ppt")) {
						System.out.println("inside>>");
						file.transferTo(new File("E:/test/source.pptx"));
						file = ocApiConvert();
						fname = base + ".swf";
						extension = "swf";						
					}
